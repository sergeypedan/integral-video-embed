    ...
    module Embed
      module Html
        ...
        class << self
          ...
          def embed_video(uid, provider:, hash: nil, embed_method: :bootstrap, width:, height:, proportions: "16by9")
            ...
            fail ArgumentError, "Unkown provider '#{provider}'. Supported are: #{Integral::Video::Provider.names.inspect}" unless Integral::Video::Provider.names.include? provider
